...
LOCAL_CFLAGS :=  	-fPIC -pthread -ldl -Wl,--no-as-needed -Wl,-soname=libproxychains4.so \
				   				...
				   				-I$(LOCAL_PATH)/libancillary \
									-DLIB_DIR=\"/data/user/0/in.zhaoj.shadowsocksr.blue-acl/lib\" -DINSTALL_PREFIX=\"/data/user/0/in.zhaoj.shadowsocksr.blue-acl/\" \
									-DDLL_NAME=\"libproxychains4.so\" -DSYSCONFDIR=\"/data/user/0/in.zhaoj.shadowsocksr.blue-acl/\"
